...
Immediately after presenting the report, write the latest analyzed version to `.claude/changelog-last-version`:

```
{latest_version}
```

Single line, just the version number (e.g. `2.1.83`). Do not ask for confirmation.
