...
- [SL-09 L60] SessionLauncher restores config from savedDefaults or lastConfig with workspace-default layering for fresh launches; resume configs bypass workspace defaults, keep forkSession when set, and clear stale continueSession/sessionId/runMode.
