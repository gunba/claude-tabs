...
- [DP-05 L90] Polls `getDebugLog()` every 500ms
- [DP-07 L121] Auto-scrolls to bottom on new entries (pauses if user scrolls up)
- [DP-08 L199] Copy button copies all visible (filtered) logs to clipboard; Clear button empties buffer
