...
- [CM-11 L40] Wide modal (84vw, max 1500px, 78vh) with 11 tabs: Settings, Env Vars, Claude, Hooks, Plugins, MCP, Agents, Prompts, Skills, Providers, Recording. Store value controls which tab opens.
